...
(() => {
  ...
  (() => {
    ...
    Object.keys(S).forEach((e) => {
      Object.defineProperty(C.fn, e, { value: S[e], writable: !0 });
    });
    const T = C;
    function _(e, t = 0) {
      ...
      slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
        ...
        if (a.cssMode) {
          ...
          if (0 === t) {
            ...
            if (!r.support.smoothScroll)
              return (
                k({ swiper: r, targetPosition: s, side: e ? "left" : "top" }),
                !0
              );
    ...
    function ge({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function a() {
        ...
        if (
          ...
          t.children(`.${s.slideVisibleClass}`).each((e) => {
            o(a ? T(e).attr("data-swiper-slide-index") : T(e).index());
          });
      ...
      function l() {
        ...
        const s = e.params.lazy.scrollingElement
            ? T(e.params.lazy.scrollingElement)
            : T(t),
          i = s[0] === t,
    ...
    function ye({ swiper: e, duration: t, transformEl: s, allSlides: i }) {
      ...
      fe({
        ...
        setTransition: (t) => {
          ...
          (s ? e.slides.find(s) : e.slides).transition(t),
            ye({ swiper: e, duration: t, transformEl: s, allSlides: !0 });
        },
        overwriteParams: () => ({
          slidesPerView: 1,
          slidesPerGroup: 1,
        ...
        setTranslate: () => {
          ...
          for (let s = 0; s < t.length; s += 1) {
            ...
            if ((g && m.shadow) || !g) {
              ...
              if ((0 === e.length && m.shadow && (e = we(r, n)), e.length)) {
                const t = r.shadowPerProgress ? d * (1 / r.limitProgress) : d;
                e[0].style.opacity = Math.min(Math.max(Math.abs(t), 0), 1);
              }
            }
            const C = ve(r, n);
            C.transform(w).css({ opacity: b }),
    ...
    window.addEventListener("load", function (e) {
      xe(),
        ...
        document.querySelector(".mainslider-students-gallery__slider") &&
          new de(".mainslider-students-gallery__slider", {
            modules: [ue, he, me, ge],
            autoplay: {
              delay: 3e3,
              disableOnInteraction: !1,
            ...
            lazy: { loadPrevNext: !0 },
            pagination: {
              el: ".control-students-gallery__fractions",
              clickable: !1,
              type: "fraction",
            },
            navigation: {
              nextEl: ".control-students-gallery__arrow_next",
              prevEl: ".control-students-gallery__arrow_prev",
            },
            breakpoints: {
              300: { spaceBetween: 10 },
              480: { spaceBetween: 15 },
        ...
        document.querySelector(".mainslider-gallery__slider") &&
          new de(".mainslider-gallery__slider", {
            modules: [ue, me, ge],
            autoplay: {
              delay: 3e3,
              disableOnInteraction: !1,
            ...
            breakpoints: {
              ...
              480: { spaceBetween: 15, slidesPerView: 2 },
              830: { spaceBetween: 30, slidesPerView: 2 },
            },
            on: {
              init: function (e) {
                const t = document.querySelector(
                    ".fraction-tabs__all_manicure"
                  ),
                  s = document.querySelector(".fraction-tabs__all_depilation"),
                  i = document.querySelector(".fraction-tabs__all_visage"),
                  n = document.querySelector(".fraction-tabs__all_solarium");
                console.log(e);
                const r = document.querySelectorAll(
                    ".mainslider-gallery__image-ibg_manicure:not(.swiper-slide-duplicate)"
                  ),
                  o = document.querySelectorAll(
                    ".mainslider-gallery__image-ibg_depilation:not(.swiper-slide-duplicate)"
                  ),
                  a = document.querySelectorAll(
                    ".mainslider-gallery__image-ibg_visage:not(.swiper-slide-duplicate)"
                  ),
                  l = document.querySelectorAll(
                    ".mainslider-gallery__image-ibg_solarium:not(.swiper-slide-duplicate)"
                  );
                (t.innerHTML = r.length < 10 ? `${r.length}` : r.length),
                  (s.innerHTML = o.length < 10 ? `${o.length}` : o.length),
                  (i.innerHTML = a.length < 10 ? `${a.length}` : a.length),
                  (n.innerHTML = l.length < 10 ? `${l.length}` : l.length);
              },
              slideChange: function (e) {
                const t = document.querySelector(
                    ".fraction-tabs__current_manicure"
                  ),
                  s = document.querySelector(
                    ".fraction-tabs__current_depilation"
                  ),
                  i = document.querySelector(".fraction-tabs__current_visage"),
                  n = document.querySelector(
                    ".fraction-tabs__current_solarium"
                  );
                (t.innerHTML =
                  e.realIndex + 1 < 10
                    ? `${e.realIndex + 1}`
        ...
        return (
            ...
            if (!(this.$container && this.$container.get())) {
              ...
              var n = this.settings.ariaLabelledby
                ...
                d =
                  ...
                  "\n                </div>\n            </div>\n        </div>\n        ";
              _e(this.settings.container).css("position", "relative").append(d),
          ...
          (e.prototype.openGallery = function (e, t) {
            ...
            if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
              ...
              this.zoomFromOrigin &&
                ...
                (r = Ae(t, this.outer, a, l, this.currentImageSize))),
          ...
          (e.prototype.addSlideVideoInfo = function (e) {
            ...
            e.forEach(function (e, s) {
              (e.__slideVideoInfo = Ge(e.src, !!e.video, s)),
                e.__slideVideoInfo &&
            ...
            "lg-slide" !== this.settings.mode &&
              ...
              setTimeout(function () {
                ...
                if (
                  ...
                  var a = _e(s.target);
                  n.isPosterElement(a) && n.LGel.trigger(Qe);
                }
              ...
              this.$inner.on("touchend.lg", function (r) {
                if ("swipe" === e.touchAction) {
                  if (i) (i = !1), e.touchEnd(s, t, r);
                    ...
                    var o = _e(r.target);
                    e.isPosterElement(o) && e.LGel.trigger(Qe);
                  }
            ...
            this.settings.enableDrag &&
              ...
              _e(window).on("mouseup.lg.global" + this.lgId, function (r) {
                if (e.lgOpened) {
                  var o = _e(r.target);
                  n
                    ? ((n = !1), e.touchEnd(s, t, r), e.LGel.trigger(et))
                    : e.isPosterElement(o) && e.LGel.trigger(Qe),
                    i &&
                      ((i = !1),
          ...
          (e.prototype.goToPrevSlide = function (e) {
            ...
            e && this.galleryItems.length < 3 && (s = !1),
              this.lgBusy ||
                (this.index > 0
                  ? (this.index--,
                    this.LGel.trigger(st, { index: this.index, fromTouch: e }),
          ...
          (e.prototype.closeGallery = function (e) {
            ...
            this.LGel.trigger(it), _e(window).scrollTop(this.prevScrollTop);
            var s,
            ...
            return (
              ...
              setTimeout(function () {
                t.zoomFromOrigin &&
                  ...
                  t.$inner.empty(),
                  t.lgOpened && t.LGel.trigger(nt, { instance: t }),
    ...
    (dt.prototype.init = function () {
      ...
      (dt.prototype.moveTo = function (e, t, s) {
      ...
      (dt.prototype.moveBack = function (e, t, s) {
    ...
    document.addEventListener("click", function (e) {
      !e.target.closest(".header__menu") &&
        innerWidth < 830 &&
        (ct.classList.remove("menu-open"), ct.classList.remove("lock"));
    });
    const ut = document.querySelector(".about__main-video");
    ut &&
      ut.addEventListener("click", function (e) {
        ut.classList.contains("_init")
          ? ut.classList.toggle("_active")
          : (ut.classList.add("_active"),
            ut.classList.add("_init"),
            ut.querySelector("video").play(),
            (ut.querySelector("video").muted = !1));
      });
    const pt = document.querySelectorAll(".item-services");
    pt &&
      pt.forEach((e) => {
    ...
    const ht = document.querySelectorAll(".item-slide_masters");
    ht &&
      ht.forEach((e) => {
        e.addEventListener("click", function (t) {
          t.target.closest(".item-slide_masters") &&
            e.classList.toggle("_master-info"),
            t.target.closest(".item-slide_masters") ||
              e.classList.remove("_master-info");
        });
      });
    const gt = document.querySelectorAll(".item-social");
    gt &&
      gt.forEach((e) => {
        e.addEventListener("click", function (t) {
    ...
    const mt = document.querySelectorAll(".item-slide_education");
    mt &&
      mt.forEach((e) => {
        e.addEventListener("click", function (t) {
          t.target.closest(".item-slide_education") &&
            e.classList.toggle("_active-slide"),
            t.target.closest(".item-slide_education") ||
              e.classList.remove("_active-slide");
        });
      });
    const ft = document.querySelectorAll(".menu-services__title");
    ft &&
      ft.forEach((e) => {
        e.addEventListener("click", function (e) {
          e.target.closest(".menu-services__title") && innerWidth > 830
            ? ct.classList.add("_services-tab")
            : ct.classList.toggle("_services-tab"),
            e.target.closest(".menu-services__title") ||
              ct.classList.remove("_services-tab");
        });
      });
    let vt = document.getElementsByClassName("menu__link"),
      yt = document.location.href;
    for (let e = 1; e < vt.length; e++)
      yt == vt[e].href && vt[e].classList.add("_active-color");
    const bt = class {
        constructor(e) {
          const t = e.dataset;
          (this.id = this.constructor.id || (this.constructor.id = 1)),
            ...
            (this.tension = 1 * t.tension || 0.4),
            (this.width = 1 * t.width || 310),
            (this.height = 1 * t.height || 100),
            (this.margin = t.margin || 30),
            (this.hoverFactor = t.hoverFactor || -0.1),
            (this.gap = t.gap || 5),
            (this.debug = t.debug || !1),
            (this.forceFactor = t.forceFactor || 0.2),
            (this.color1 = t.color1 || "#36DFE7"),
            (this.color2 = t.color2 || "#8F17E1"),
            (this.color3 = t.color3 || "#BF09E6"),
            (this.textColor = t.textColor || "#ebe691"),
            (this.text = t.text || "Button"),
            (this.content = t.content || "Smth"),
            (this.svg = e),
            (this.layers = [
          ...
          for (let e = 0; e < this.layers.length; e++) {
            ...
            (s.viscosity =
              1 * t["layer-" + (e + 1) + "Viscosity"] || s.viscosity),
              (s.mouseForce =
                1 * t["layer-" + (e + 1) + "MouseForce"] || s.mouseForce),
              (s.forceLimit =
                1 * t["layer-" + (e + 1) + "ForceLimit"] || s.forceLimit),
              (s.path = document.createElementNS(this.xmlns, "path")),
              this.svg.appendChild(s.path);
          }
          (this.wrapperElement = t.wrapperElement || document.body),
            this.svg.parentElement || this.wrapperElement.append(this.svg),
            (this.svgText = document.createElementNS(this.xmlns, "text")),
            this.svgText.setAttribute("x", "50%"),
            this.svgText.setAttribute("y", "50%"),
            this.svgText.setAttribute("dy", ~~(this.height / 8) + "px"),
            (this.svgText.style.fontFamily = "Montserrat, sans-serif"),
          ...
          return (e) => {
            ...
            for (let s = 0; s < e.changedTouches.length; s++) {
              ...
              n > 0 &&
                ...
                n < this.svgWidth &&
                r < this.svgHeight &&
                this.touches.push({ x: n, y: r, force: i.force || 1 });
            }
            e.preventDefault();
          };
        }
        ...
        update() {
          for (let e = 0; e < this.layers.length; e++) {
            ...
            for (let e = 0; e < s.length; e++) {
              const i = s[e],
                n = i.ox - i.x + (Math.random() - 0.5) * this.noise,
                r = i.oy - i.y + (Math.random() - 0.5) * this.noise,
                o = Math.sqrt(n * n + r * r),
                a = o * this.forceFactor;
              (i.vx += a * (n / o || 0)), (i.vy += a * (r / o || 0));
              for (let e = 0; e < this.touches.length; e++) {
                const s = this.touches[e];
                let n = t.mouseForce;
                s.x > this.margin &&
                  s.x < this.margin + this.width &&
                  s.y > this.margin &&
                  s.y < this.margin + this.height &&
                  (n *= -this.hoverFactor);
                const r = i.x - s.x,
                  o = i.y - s.y,
                  a = Math.sqrt(r * r + o * o),
                  l = Math.max(
                    -t.forceLimit,
                    Math.min(t.forceLimit, (n * s.force) / a)
                  );
                (i.vx += l * (r / a || 0)), (i.vy += l * (o / a || 0));
              }
              (i.vx *= t.viscosity),
                (i.vy *= t.viscosity),
                (i.x += i.vx),
            ...
            for (let e = 0; e < s.length; e++) {
              const t = s[(e + s.length - 1) % s.length],
                i = s[e],
                n = s[(e + s.length + 1) % s.length],
                r = this.distance(i, t),
                o = this.distance(i, n),
                a = { x: n.x - t.x, y: n.y - t.y },
                l = Math.sqrt(a.x * a.x + a.y * a.y);
              (i.cPrev = {
                x: i.x - (a.x / l) * r * this.tension,
                y: i.y - (a.y / l) * r * this.tension,
              }),
                (i.cNext = {
                  x: i.x + (a.x / l) * o * this.tension,
                  y: i.y + (a.y / l) * o * this.tension,
                });
            }
          }
        }
        animate() {
          this.raf(() => {
            this.update(), this.draw(), this.animate();
          });
        }
        get svgWidth() {
          ...
          for (let e = 0; e < this.layers.length; e++) {
            ...
            if (1 === e)
              if (this.touches.length > 0) {
                for (; this.svgDefs.firstChild; )
                  this.svgDefs.removeChild(this.svgDefs.firstChild);
                for (let e = 0; e < this.touches.length; e++) {
                  const s = this.touches[e],
                    i = document.createElementNS(this.xmlns, "radialGradient");
                  i.id = "liquid-gradient-" + this.id + "-" + e;
                  const n = document.createElementNS(this.xmlns, "stop");
                  n.setAttribute("stop-color", this.color3),
                    n.setAttribute("offset", "0%");
                  const r = document.createElementNS(this.xmlns, "stop");
                  r.setAttribute("stop-color", this.color2),
                    r.setAttribute("offset", "100%"),
                    i.appendChild(n),
                    i.appendChild(r),
                    this.svgDefs.appendChild(i),
                    i.setAttribute("cx", s.x / this.svgWidth),
                    i.setAttribute("cy", s.y / this.svgHeight),
                    i.setAttribute("r", s.force),
                    (t.path.style.fill = "url(#" + i.id + ")");
                }
              } else t.path.style.fill = this.color2;
            else t.path.style.fill = this.color1;
            const s = t.points,
              i = [];
            i.push("M", s[0].x, s[0].y);
            for (let e = 1; e < s.length; e += 1)
              i.push(
                "C",
                s[(e + 0) % s.length].cNext.x,
                s[(e + 0) % s.length].cNext.y,
                s[(e + 1) % s.length].cPrev.x,
                s[(e + 1) % s.length].cPrev.y,
                s[(e + 1) % s.length].x,
                s[(e + 1) % s.length].y
              );
            i.push("Z"), t.path.setAttribute("d", i.join(" "));
          }
          (this.svgText.textContent = this.text),
            (this.svgText.style.fill = this.textColor);
        }
        createPoint(e, t) {
          return { x: e, y: t, ox: e, oy: t, vx: 0, vy: 0 };
        }
        initOrigins() {
          ...
          for (let e = 0; e < this.layers.length; e++) {
            ...
            for (
              ...
              s.push(this.createPoint(e + this.margin, this.margin));
            for (let e = ~~(1.25 * this.height); e >= 0; e -= this.gap) {
              const t = (Math.PI / ~~(1.25 * this.height)) * e;
              s.push(
                this.createPoint(
                  (Math.sin(t) * this.height) / 2 +
                    this.margin +
                    this.width -
                    this.height / 2,
                  (Math.cos(t) * this.height) / 2 +
                    this.margin +
                    this.height / 2
                )
              );
            ...
            for (
              let e = this.width - ~~(this.height / 2) - 1;
              e >= ~~(this.height / 2);
              e -= this.gap
            )
              s.push(
                this.createPoint(e + this.margin, this.margin + this.height)
              );
            for (let e = 0; e <= ~~(1.25 * this.height); e += this.gap) {
              const t = (Math.PI / ~~(1.25 * this.height)) * e;
              s.push(
                this.createPoint(
                  this.height -
      ...
      wt = document.getElementsByClassName("liquid-button");
    for (let e = 0; e < wt.length; e++) {
      const t = wt[e];
      t.liquidButton = new bt(t);
    }
    (window.FLS = !0),
      (function (e) {
        let t = new Image();
